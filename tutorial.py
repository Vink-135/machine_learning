...
class Square(Rectangle):
    def _init_(self, colour, side_length):
        super()._init_(colour, side_length, side_length)
...
class Parallelogram(Rectangle):
    def _init_(self, colour, base, height):
        super()._init_(colour, base, height)
        self.base = base
        self.height = height
...
class Bus(Vehicle):
    def _init_(self, seating_capacity=50):
